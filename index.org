...
<div align="center" class="intro">
 ...
 <tr><td>
	...
	<!--
	    ...
	    var img = imgAr[ num ];
            var alt = imgAlt[num];
	    var imgStr = '<img src="' + path + img + '" alt = "Hallo" style="width:100%;max-width:400px;"></a></td></tr><tr><td class="caption" style="text-align:right; font-size:10pt; font-style:italic;">' + alt + '</td></tr>';
