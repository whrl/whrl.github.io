...
<div class="intro">
	...
	<!--
	    ...
	    var img = imgAr[ num ];
            var alt = imgAlt[num];
	    var imgStr = '<table id="image"><tr><td><a href="http://whrl.github.io/toni.html" style="text-decoration: none"><img src="' + path + img + '" alt = "" style="width:100%;max-width:400px;"></a></td></tr><tr><td class="caption" style="text-align:right; font-size:10pt; font-style:italic;">' + alt + '</td></tr></table>';
