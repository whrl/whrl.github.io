...
<div style="text-align:center;">
	...
	<!--
	    ...
	    var imgStr = '<table id="image" style="margin-left:auto; margin-right:auto;border: 1px solid #ccc;box-shadow: 3px 3px 3px #eee;padding: 8pt;overflow: auto;"><tr><td><a href="http://whrl.github.io/toni.html" style="text-decoration: none"><img src="' + path + img + '" alt = "" style="width:100%;max-width:400px;"></a></td></tr><tr><td class="caption" style="text-align:right; font-size:smaller; font-style:italic;">' + alt + '</td></tr></table>';
