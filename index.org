...
<div style="text-align:center;">
  ...
  <br/>
  <br/><div style="font-size:smaller;"><a href="javascript:myWindow('http://validator.w3.org/check?uri=referer', 'Validation')">Validate</a> <a href="javascript:myWindow('http://whrl.github.io/impressum.html', 'Impressum')">Impressum</a> <a href="javascript:myWindow('http://www.disclaimer.de/disclaimer.htm','Haftungsausschluss')">Haftungsausschluss</a> <a href="javascript:myWindow('http://www.disclaimer.de/disclaimer.htm#2','Disclaimer')">Disclaimer</a></div></div>
#+end_html 
